    ...
    <footer className="bg-black py-10 px-4">
      <div className="container max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            <h2 className="text-2xl font-bold">Jane<span className="text-accent">Doe</span></h2>
          </motion.div>
          
          <motion.div
            className="flex flex-wrap justify-center space-x-6 mt-6 md:mt-0"
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
        ...
        <motion.div
          className="border-t border-white/10 mt-8 pt-8 flex flex-col-reverse md:flex-row justify-between items-center"
          initial={{ opacity: 0 }}
